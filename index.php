...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand badge bg-success text-wrap" style="width: 6rem; font-size: 1.5rem; font-weight: bold; padding: 0.5rem 1rem; border-radius: 0.5rem; text-transform: uppercase; letter-spacing: 0.1rem; transition: background-color 0.3s ease, color 0.3s ease;" href="#home">VUVA</a>
            ...
            <div class="collapse navbar-collapse justify-content-evenly" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#why-choose-us">About</a>
                    </li>
                    ...
                    <div class="row flex-wrap">
                        <div class="col-lg-4">
                            <div class="card justify-content-center" style="background-color: white; padding-bottom: 20px; width: 300px; border-radius: 20px; color: black;">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Fast Deliveries</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
        ...
        <div class="container my-4" style="background: url('img/nike.jpg') center/cover no-repeat fixed; border-radius: 20px; overflow: hidden;">
            ...
            <div class="row d-flex">
                <div class="col-md-6 offset-md-3">
                    <div class="card" style="background-color: #f7f7f7; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px rgba(0,0,0,0); margin-top: 50px;">
            ...
            <div class="row d-flex">
                <div class="col-md-6 offset-md-3">
                    <div class="card" style="color: green; background-color: #f7f7f7; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px rgba(0,0,0,0); margin-top: 50px;">
